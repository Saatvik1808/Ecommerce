    ...
    <div className="footer bg-dark text-white py-3">
      <div className="container text-center">
        ...
        <div className="social-links">
          <a
            className="btn btn-link btn-floating btn-lg text-dark m-1 github-icon"
          ...
          <a
            className="btn btn-link btn-floating btn-lg text-dark m-1 instagram-icon"
          ...
          <a
            className="btn btn-link btn-floating btn-lg text-dark m-1 linkedin-icon"
